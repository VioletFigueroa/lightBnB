...
VALUES (
    ...
    Speed lamp,
    description,
    https: / / images.pexels.com / photos / 2086676 / pexels - photo -2086676.jpeg ? auto = compress & amp;
cs = tinysrgb & amp;
h = 350,
...
(
  ...
  Blank corner,
  description,
  https: / / images.pexels.com / photos / 2121121 / pexels - photo -2121121.jpeg ? auto = compress & amp;
cs = tinysrgb & amp;
h = 350,
...
(
  ...
  Habit mix,
  description,
  https: / / images.pexels.com / photos / 2080018 / pexels - photo -2080018.jpeg ? auto = compress & amp;
cs = tinysrgb & amp;
h = 350,
...
(
  ...
  Headed know,
  description,
  https: / / images.pexels.com / photos / 1029599 / pexels - photo -1029599.jpeg ? auto = compress & amp;
cs = tinysrgb & amp;
h = 350,
...
(
  ...
  Port out,
  description,
  https: / / images.pexels.com / photos / 1475938 / pexels - photo -1475938.jpeg ? auto = compress & amp;
cs = tinysrgb & amp;
h = 350,
...
(
  ...
  Fun glad,
  description,
  https: / / images.pexels.com / photos / 1172064 / pexels - photo -1172064.jpeg ? auto = compress & amp;
cs = tinysrgb & amp;
h = 350,
...
(
  ...
  Shine twenty,
  description,
  https: / / images.pexels.com / photos / 2076739 / pexels - photo -2076739.jpeg ? auto = compress & amp;
cs = tinysrgb & amp;
h = 350,
...
(
  ...
  Game fill,
  description,
  https: / / images.pexels.com / photos / 1756826 / pexels - photo -1756826.jpeg ? auto = compress & amp;
cs = tinysrgb & amp;
h = 350,
